...
from .permissions import IsAdmin, IsAdminOrReadOnly, ReviewAndCommentPermission
from .utils import create_token, generate, send_confirmation_code
...
class RegisterAPIView(APIView):
    ...
    register_serializer = serializers.RegisterSerializer
